...
<!-- BEGIN HEAD -->
    ...
    <body class="terapis">
        ...
        <div class="home-button">
            <form class="terapis-form" action="{{ url('menuRefleksi') }}" method="post"> 
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="noGelang" value="{{ $nama }}">

                <br>
                <p style='font-size: 40px; color: white;'>MENU REFLEXY</p>
                ...
                <div>
                    <button type="button" onclick="location.href = '{{ url('menuRefleksiStop') }}';">STOP</button>
                </div>

                <div>
                    <button type="button" onclick="location.href = '{{ url('durasiRefleksi') }}';">DURASI</button>
                </div>
            </form>
        </div>
