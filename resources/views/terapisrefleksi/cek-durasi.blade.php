...
<!-- BEGIN HEAD -->
    ...
    <body class="terapis">
        ...
        <!-- END LOGO -->
        <p style='font-size: 30px; color: white; text-align: center;'>CEK DURASI REFLEXY</p>
        <p style='font-size: 30px; color: white; text-align: center;'>SCAN KARTU TERAPIS</p>
        <br>
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->

            <form class="terapis-form" action="{{ url('durasiRefleksi') }}" method="post">
