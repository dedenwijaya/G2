...
<!-- BEGIN HEAD -->
    <head>
        <meta charset="utf-8"/>
        <title>Refleksi Auto Menu</title>
    ...
    <body class="terapis">
        ...
        <div class="content">
            ...
            <form class="terapis-form" action="{{ url('autoKonfirmasiRefleksi') }}" method="post">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input id="terapis-barcode" class="form-control placeholder-no-fix" type="text" style='font-size: 24px;' autocomplete="off" placeholder="Scan No. Terapis" name="noKartu" autofocus/>
                    </div>
                </div>
                <br>
    ...
    function CustomConfirm(){
        ...
        this.yes = function(){            
            location.href = '{{ url('menuRefleksi') }} ';
        }
    }
