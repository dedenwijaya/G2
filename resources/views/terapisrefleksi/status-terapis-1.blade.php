...
<!-- BEGIN HEAD -->
    ...
    <!-- BEGIN BODY -->
    <body class="status-terapis status-terapis-1">
        <!-- BEGIN LOGIN -->
        <br>
        <div class="content content-1">
            ...
            <form class="login-form">    
                ...
                <div class="portlet-body">
                    <div class="table1" >
                    <table class="table table-1 daftar-1" >
                        <thead>
                        <tr>
                            <th>
                                 No.
                        ...
                        <tbody>
                            ...
                            @foreach ($transaksi->forPage(1, 20) as $trans)
                        <tr>
                            <td>
                                {{ $count++ }}
                            </td>
                    ...
                    <table class="table table-1 daftar-1" >
                        ...
                        <tbody>
                            <p class="hidden">{{ $count = 21 }}</p>
                            @foreach ($transaksi->forPage(2, 20) as $trans)
                        <tr>
                            <td>
                                {{ $count++ }}
                            </td>
                    ...
                    <table class="table table-1 daftar-1" >
                        ...
                        <tbody>
                            <p class="hidden">{{ $count = 41 }}</p>
                            @foreach ($transaksi->forPage(3, 20) as $trans)
                        <tr>
                            <td>
                                {{ $count++ }}
                            </td>
                    ...
                    <table class="table table-1 daftar-1" >
                        ...
                        <tbody>
                            <p class="hidden">{{ $count = 61 }}</p>
                            @foreach ($transaksi->forPage(4, 20) as $trans)
                        <tr>
                            <td>
                                {{ $count++ }}
                            </td>
