...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('updateStock2') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <h3 class="form-title" style='font-size: 38px;'>Stock 2 Add</h3>
                <ul>
                ...
                <div class="form-actions">
                    <button type="button" onclick="location.href = '{{ url('stock2') }}';" class="btn btn-primary pull-left">
