...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('updateStock4') }}" method="post">
                ...
                <div class="form-actions">
                    <button type="button" onclick="location.href = '{{ url('stock4') }}';" class="btn btn-primary pull-left">
