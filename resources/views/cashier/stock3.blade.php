            ...
            <!-- BEGIN LOGIN FORM -->
                ...
                <div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ url('stock3') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                ...
                                <button type="submit" formaction="{{ url('item3Delete') }}" class="btn btn-default btn-xs hidden" style="font-size:16px;"><i class="fa fa-eraser"></i> Hapus</button>
                            </form>
                        </td>
                    </tr>    
                    @endforeach   
