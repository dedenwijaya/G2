...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('pendapatan-terapis') }}" method="post">
                ...
                <div class="form-group hidden-print">
                    <div class="input-group">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" style='font-size: 24px;' autocomplete="off" placeholder="No. Terapis" name="noTerapis"/>
                    </div>
                </div>
