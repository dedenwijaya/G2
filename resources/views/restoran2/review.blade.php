...
<!-- BEGIN HEAD -->
    ...
    <body class="login">
        ...
        <div class="content" style="margin-top: 50px;">
            <form action="{{ url('restoran2/back') }}" method="post" id="formnya">
            ...
            <input class="hidden" name="total" value="{{ $total }}">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="submit" formaction="{{ URL::action('Restoran2Controller@delete', array('id'=>$item['index'])) }}" class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button>
                                    </td>
                                </tr>    
                                @endforeach     
                            </tbody>
                ...
                <div class="form-actions hidden-print">
                    ...
                    <div class="pull-right">
                        <button type="submit" formaction="{{ url('restoran2/order') }}" class="btn btn-success">
