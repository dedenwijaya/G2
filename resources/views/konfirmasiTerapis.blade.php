...
<!-- BEGIN HEAD -->
    <head>
        <meta charset="utf-8"/>
        <title>Konfirmasi Terapis</title>
    ...
    <body class="login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('konfirmasiTerapis') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <h3 class="form-title" style='font-size: 38px;'>Konfirmasi Terapis</h3>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="hidden" type="" autocomplete="off" placeholder="" name="noKartu" value="{{ $noKartu }}"/>
                        <input class="hidden" type="" autocomplete="off" placeholder="" name="noGelang" value="{{ $noGelang }}"/>
                    </div>
                </div>
