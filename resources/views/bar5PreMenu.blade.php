...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('bar5PreMenu') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <h3 class="form-title" style='font-size: 38px;'>Menu Bar Lantai 5</h3>

				<p style='font-size: 16px; color: green'>{{ $success }}</p>
                <div class="form-actions" >
                    <button type="button" onclick="location.href = '{{ url('cariBar5Pre') }}';" class="btn btn-default pull-left" id="cari">
                        <span class="glyphicon glyphicon-search"></span> Cek Saldo
                    </button>
                    <button type="button" class="btn btn-success pull-right" onclick="location.href = '{{ url('stock_bar5') }}';">
                ...
                <div class="form-actions">
                    <button type="button" onclick="location.href = '{{ url('auth/bar5Logout') }}';" class="btn btn-primary">
