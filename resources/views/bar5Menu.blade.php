...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('bar5MenuAdd') }}" method="post">
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <input class="hidden" name="noKartu" value="{{ $noKartu }}">
                                            ...
                                            <button type="submit" formaction="{{ url('bar5ItemDelete') }}" class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button>
                                        </form>
                                    </td>
                                </tr>    
                                @endforeach     
            ...
            <form method="post">
                ...
                <div class="form-actions hidden-print">
                        <div class="pull-left">
                            <button type="button" onclick="location.href = '{{ url('bar5PreMenu') }}';" class="btn btn-primary">
                                <span class="glyphicon glyphicon-chevron-left"></span> Back
                            </button>
                        </div>
                        <div class="pull-right">
                            <button type="submit" formaction="{{ url('bar5Invoice') }}" class="btn btn-success">
