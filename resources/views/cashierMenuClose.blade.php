...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
            ...
            <div class="page-container">
                ...
                <div class="form-actions" >
                    <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#closeMd1">
                        <span class="glyphicon glyphicon-folder-close"></span> Close Transaction
                    </button>
        ...
        <!-- END LOGIN -->
        <!-- BEGIN MODAL-->
        <div id="closeMd2" class="modal fade" tabindex="-1" aria-hidden="true">
            
            
            <form class="login-form" action="{{ url('closeTransaction') }}" method="get">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
        ...
        <div id="closeMd1" class="modal fade" tabindex="-1" aria-hidden="true">
            
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h3 class="modal-title">Anda yakin ingin menutup transaksi?</h3>

                        <div class="modal-footer">
                            <button type="button" data-dismiss="modal" class="btn btn-default">Batal</button>
                            <button type="submit" data-dismiss="modal" class="btn btn-success" id="openTrans" data-toggle="modal" data-target="#closeMd2">Lanjut</button>
                        </div>
                    </div>
