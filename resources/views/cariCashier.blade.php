...
<!--            <img src="assets/img/logo.png" alt=""/>-->
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('cariCashier') }}" method="post">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input id="barcode" class="form-control placeholder-no-fix" type="text" style='font-size: 24px;' autocomplete="off" placeholder="Nomor Kartu" name="noKartu"/>
                    </div>
                </div>
