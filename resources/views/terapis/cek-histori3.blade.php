...
<!-- BEGIN HEAD -->
    ...
    <body class="terapis">
        ...
        <!-- END LOGO -->
        <p style='font-size: 60px; color: white; text-align: center;'>CEK HISTORI</p>
        ...
        <div class="content">
            ...
            <form class="terapis-form" action="{{ url('historiPelanggan3') }}" method="post">
    ...
    function CustomConfirm(){
        ...
        this.yes = function(){            
            location.href = '{{ url('menuPelanggan3') }} ';
        }
    }
