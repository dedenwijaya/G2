...
<!-- BEGIN HEAD -->
    ...
    <body class="terapis">
        ...
        <div class="home-button">
            <form class="terapis-form" action="{{ url('saldoCek3') }}" method="post"> 
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="noGelang" value="{{ $nama }}">

                <br>
                <p style='font-size: 40px; color: white;'>MENU PELANGGAN LANTAI 3</p>
                ...
                <div>
                    <button type="button" onclick="location.href = '{{ url('restoran3') }}';">ORDER</button>
                </div>
                ...
                <div>
                    <button type="button" onclick="location.href = '{{ url('historiCek3') }}';">HISTORY</button>
                </div>
            </form>
        </div>
