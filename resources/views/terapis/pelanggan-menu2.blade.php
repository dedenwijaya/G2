...
<!-- BEGIN HEAD -->
    ...
    <body class="terapis">
        <div class="home-button">
            <form class="terapis-form" action="{{ url('saldoCek2') }}" method="post"> 
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="noGelang" value="{{ $nama }}">

                <br>
                <p style='font-size: 40px; color: white;'>MENU PELANGGAN LANTAI 2</p>
                ...
                <div>
                    <button type="button" onclick="location.href = '{{ url('restoran2') }}';">ORDER</button>
                </div>
                ...
                <div>
                    <button type="button" onclick="location.href = '{{ url('historiCek2') }}';">HISTORY</button>
                </div>
            </form>
        </div>
