...
<!-- BEGIN HEAD -->
    ...
    <body class="login" style="margin-top: 0px">
        <!-- BEGIN LOGIN -->
        <form action="{{ url('restoran5/review') }}" method="post" id="formnya">
            ...
            <div class="terapis menu">
                ...
                <button type="button" onclick="location.href = '{{ url('restoran5') }}';" class="btn btn-primary" style="margin-left: 30px; padding: 20px; font-size: 32px">
                    <span class="glyphicon glyphicon-chevron-left"></span> Keluar
                </button>
                <button type="submit" formaction="{{ url('restoran5/ob') }}" class="btn btn-primary" style="margin-right: 30px; padding: 10px 40px; font-size: 28px; float: right;">
                    OB
                </button>
            </div>
    ...
    <script>
        ...
        function startCount(){
            counter = setTimeout(function(){ location.href = "{{ url('restoran5') }} "; }, 8000);
        }
