...
<!-- BEGIN HEAD -->
    ...
    <body class="terapis">
        ...
        <!-- END LOGO -->
        <p style='font-size: 70px; color: white; text-align: center;'>MENU RESTORAN LANTAI 5</p>
        <br>
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->

            <form class="terapis-form" action="{{ url('restoran5') }}" method="post">
    ...
    function CustomConfirm(){
        ...
        this.yes = function(){            
            location.href = '{{ url('menuPelanggan5') }} ';
        }
    }
